$(document).ready(function(){
    $("#ModifyGame").submit(function(e){
        ...
        if (GameName.length < 8 || GameName.length > 20){
            IsEntrar = true;
            Mensaje += "El nombre modificado de su juego debe tener entre 8 y 20 caracteres<br>";
        }
        if (GameDescription.length < 50 || GameDescription.length > 250){
            IsEntrar = true;
            Mensaje += "La descripción modificada de su juego debe tener entre 50 y 250 caracteres<br>";
        }
